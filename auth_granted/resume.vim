...
set noequalalways
set errorformat=%\\S%\\+\ \ %#%[cefi]%[rxod]%[eir]%[a-z]%#%\\x1b[0m\ %\\+%\\S%\\+%$%\\&%\\x1b%\\S%\\+\ \ %#%m%\\>%\\x1b[0m\ \ %#%f,%\\s\ %#%[cefi]%[rxod]%[eir]%[a-z]%#\ %\\+%\\S%\\+%$%\\&%\\s\ %#%m%\\>\ \ %#%f,Overwrite%.%#%\\S%\\+\ \ %#%m%\\x1b[0m\ \ %#%f,%-GOverwrite%.%#\"h\"%.%#,%.%#rails\ test\ %f:%l,%+GCurrent\ version:%.%#,%+G\ %#Status\ %#Migration\ ID%.%#,%+G\ The\ fixture\ ID\ for\ %.%#,%f:\ %s\ (%m)%$%\\&%.%#/fixtures/%.%#(%\\d%\\+),%+G\ %#Prefix\ %#Verb%.%#,%+G\ %#Code\ LOC:\ %.%#,%+GAbout\ your\ application's\ environment,%+Grun\ %\\S%#::Application.routes,%+Irails\ %\\S%\\+%\\s%\\+#\ %.%#,%+Eruby:%.%#(LoadError),%+EUsage:%.%#,%+ECould\ not\ find\ generator%.%#,%+EType\ 'rails'\ for\ help.,%D(in\ %f),%\\s%#from\ %f:%l:%m,%\\s%#from\ %f:%l:,%\\s%##\ %f:%l:%m,%\\s%##\ %f:%l,%\\s%#[%f:%l:\ %#%m,%\\s%#%f:%l:\ %#%m,%\\s%#%f:%l:,%m\ [%f:%l]:,%+Erake\ aborted!,%+EDon't\ know\ how\ to\ build\ task\ %.%#,%+Einvalid\ option:%.%#,%+Irake\ %\\S%\\+%\\s%\\+#\ %.%#,chdir\ /Users/toka/rails_work/auth/auth_granted
set expandtab
...
silent only
cd ~/rails_work/auth/auth_granted
...
badd +6 app/controllers/customers_controller.rb
badd +0 app/policies/access_policy.rb
badd +0 app/controllers/application_controller.rb
argglobal
silent! argdel *
edit app/policies/access_policy.rb
...
setlocal path=~/rails_work/auth/auth_granted/lib,~/rails_work/auth/auth_granted/vendor,~/rails_work/auth/auth_granted/app/models/concerns,~/rails_work/auth/auth_granted/app/controllers/concerns,~/rails_work/auth/auth_granted/app/controllers,~/rails_work/auth/auth_granted/app/helpers,~/rails_work/auth/auth_granted/app/mailers,~/rails_work/auth/auth_granted/app/models,~/rails_work/auth/auth_granted/app/jobs,~/rails_work/auth/auth_granted/app/*,~/rails_work/auth/auth_granted/app/views,~/rails_work/auth/auth_granted/test,~/rails_work/auth/auth_granted/test/unit,~/rails_work/auth/auth_granted/test/functional,~/rails_work/auth/auth_granted/test/integration,~/rails_work/auth/auth_granted/test/controllers,~/rails_work/auth/auth_granted/test/helpers,~/rails_work/auth/auth_granted/test/mailers,~/rails_work/auth/auth_granted/test/models,~/rails_work/auth/auth_granted/test/jobs,~/rails_work/auth/auth_granted/vendor/plugins/*/lib,~/rails_work/auth/auth_granted/vendor/plugins/*/test,~/rails_work/auth/auth_granted/vendor/rails/*/lib,~/r
...
silent! normal! zE
let s:l = 46 - ((8 * winheight(0) + 11) / 23)
...
setlocal numberwidth=4
setlocal omnifunc=rubycomplete#Complete
setlocal path=~/rails_work/auth/auth_granted/lib,~/rails_work/auth/auth_granted/vendor,~/rails_work/auth/auth_granted/app/models/concerns,~/rails_work/auth/auth_granted/app/controllers/concerns,~/rails_work/auth/auth_granted/app/controllers,~/rails_work/auth/auth_granted/app/helpers,~/rails_work/auth/auth_granted/app/mailers,~/rails_work/auth/auth_granted/app/models,~/rails_work/auth/auth_granted/app/jobs,~/rails_work/auth/auth_granted/app/*,~/rails_work/auth/auth_granted/app/views,~/rails_work/auth/auth_granted/app/views/customers,~/rails_work/auth/auth_granted/app/views/application,~/rails_work/auth/auth_granted/public,~/rails_work/auth/auth_granted/test,~/rails_work/auth/auth_granted/test/unit,~/rails_work/auth/auth_granted/test/functional,~/rails_work/auth/auth_granted/test/integration,~/rails_work/auth/auth_granted/test/controllers,~/rails_work/auth/auth_granted/test/helpers,~/rails_work/auth/auth_granted/test/mailers,~/rails_work/auth/auth_granted/test/models,~/rails_work/auth/auth_granted/test/jobs,~/rails_work/aut
setlocal nopreserveindent
setlocal nopreviewwindow
setlocal quoteescape=\\
setlocal noreadonly
...
setlocal numberwidth=4
setlocal omnifunc=rubycomplete#Complete
setlocal path=~/rails_work/auth/auth_granted/lib,~/rails_work/auth/auth_granted/vendor,~/rails_work/auth/auth_granted/app/models/concerns,~/rails_work/auth/auth_granted/app/controllers/concerns,~/rails_work/auth/auth_granted/app/controllers,~/rails_work/auth/auth_granted/app/helpers,~/rails_work/auth/auth_granted/app/mailers,~/rails_work/auth/auth_granted/app/models,~/rails_work/auth/auth_granted/app/jobs,~/rails_work/auth/auth_granted/app/*,~/rails_work/auth/auth_granted/app/views,~/rails_work/auth/auth_granted/app/views/application,~/rails_work/auth/auth_granted/public,~/rails_work/auth/auth_granted/test,~/rails_work/auth/auth_granted/test/unit,~/rails_work/auth/auth_granted/test/functional,~/rails_work/auth/auth_granted/test/integration,~/rails_work/auth/auth_granted/test/controllers,~/rails_work/auth/auth_granted/test/helpers,~/rails_work/auth/auth_granted/test/mailers,~/rails_work/auth/auth_granted/test/models,~/rails_work/auth/auth_granted/test/jobs,~/rails_work/auth/auth_granted/vendor/plugins/*/lib,~/rails_work/au
setlocal nopreserveindent
setlocal nopreviewwindow
setlocal quoteescape=\\
setlocal noreadonly
