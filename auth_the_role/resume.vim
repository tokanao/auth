...
set noequalalways
set errorformat=%\\S%\\+\ \ %#%[cefi]%[rxod]%[eir]%[a-z]%#%\\x1b[0m\ %\\+%\\S%\\+%$%\\&%\\x1b%\\S%\\+\ \ %#%m%\\>%\\x1b[0m\ \ %#%f,%\\s\ %#%[cefi]%[rxod]%[eir]%[a-z]%#\ %\\+%\\S%\\+%$%\\&%\\s\ %#%m%\\>\ \ %#%f,Overwrite%.%#%\\S%\\+\ \ %#%m%\\x1b[0m\ \ %#%f,%-GOverwrite%.%#\"h\"%.%#,%.%#rails\ test\ %f:%l,%+GCurrent\ version:%.%#,%+G\ %#Status\ %#Migration\ ID%.%#,%+G\ The\ fixture\ ID\ for\ %.%#,%f:\ %s\ (%m)%$%\\&%.%#/fixtures/%.%#(%\\d%\\+),%+G\ %#Prefix\ %#Verb%.%#,%+G\ %#Code\ LOC:\ %.%#,%+GAbout\ your\ application's\ environment,%+Grun\ %\\S%#::Application.routes,%+Irails\ %\\S%\\+%\\s%\\+#\ %.%#,%+Eruby:%.%#(LoadError),%+EUsage:%.%#,%+ECould\ not\ find\ generator%.%#,%+EType\ 'rails'\ for\ help.,%D(in\ %f),%\\s%#from\ %f:%l:%m,%\\s%#from\ %f:%l:,%\\s%##\ %f:%l:%m,%\\s%##\ %f:%l,%\\s%#[%f:%l:\ %#%m,%\\s%#%f:%l:\ %#%m,%\\s%#%f:%l:,%m\ [%f:%l]:,%+Erake\ aborted!,%+EDon't\ know\ how\ to\ build\ task\ %.%#,%+Einvalid\ option:%.%#,%+Irake\ %\\S%\\+%\\s%\\+#\ %.%#,chdir\ /Users/toka/rails_work/auth/auth_the_role
set expandtab
...
silent only
cd ~/rails_work/auth/auth_the_role
...
badd +0 app/controllers/customers_controller.rb
argglobal
silent! argdel *
...
setlocal path=~/rails_work/auth/auth_the_role/lib,~/rails_work/auth/auth_the_role/vendor,~/rails_work/auth/auth_the_role/app/models/concerns,~/rails_work/auth/auth_the_role/app/controllers/concerns,~/rails_work/auth/auth_the_role/app/controllers,~/rails_work/auth/auth_the_role/app/helpers,~/rails_work/auth/auth_the_role/app/mailers,~/rails_work/auth/auth_the_role/app/models,~/rails_work/auth/auth_the_role/app/jobs,~/rails_work/auth/auth_the_role/app/*,~/rails_work/auth/auth_the_role/app/views,~/rails_work/auth/auth_the_role/app/views/customers,~/rails_work/auth/auth_the_role/app/views/application,~/rails_work/auth/auth_the_role/public,~/rails_work/auth/auth_the_role/test,~/rails_work/auth/auth_the_role/test/unit,~/rails_work/auth/auth_the_role/test/functional,~/rails_work/auth/auth_the_role/test/integration,~/rails_work/auth/auth_the_role/test/controllers,~/rails_work/auth/auth_the_role/test/helpers,~/rails_work/auth/auth_the_role/test/mailers,~/rails_work/auth/auth_the_role/test/models,~/rails_work/auth/auth_the_role/tes
...
4
normal! 08|
lcd ~/rails_work/auth/auth_the_role
wincmd w
argglobal
edit ~/rails_work/auth/auth_the_role/app/controllers/application_controller.rb
let s:cpo_save=&cpo
set cpo&vim
cmap <buffer>  <Plug><cfile>
cmap <buffer>  <Plug><cword>
...
setlocal numberwidth=4
setlocal omnifunc=rubycomplete#Complete
setlocal path=~/rails_work/auth/auth_the_role/lib,~/rails_work/auth/auth_the_role/vendor,~/rails_work/auth/auth_the_role/app/models/concerns,~/rails_work/auth/auth_the_role/app/controllers/concerns,~/rails_work/auth/auth_the_role/app/controllers,~/rails_work/auth/auth_the_role/app/helpers,~/rails_work/auth/auth_the_role/app/mailers,~/rails_work/auth/auth_the_role/app/models,~/rails_work/auth/auth_the_role/app/jobs,~/rails_work/auth/auth_the_role/app/*,~/rails_work/auth/auth_the_role/app/views,~/rails_work/auth/auth_the_role/app/views/application,~/rails_work/auth/auth_the_role/public,~/rails_work/auth/auth_the_role/test,~/rails_work/auth/auth_the_role/test/unit,~/rails_work/auth/auth_the_role/test/functional,~/rails_work/auth/auth_the_role/test/integration,~/rails_work/auth/auth_the_role/test/controllers,~/rails_work/auth/auth_the_role/test/helpers,~/rails_work/auth/auth_the_role/test/mailers,~/rails_work/auth/auth_the_role/test/models,~/rails_work/auth/auth_the_role/test/jobs,~/rails_work/auth/auth_the_role/vendor/plugin
setlocal nopreserveindent
setlocal nopreviewwindow
setlocal quoteescape=\\
setlocal noreadonly
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 20 - ((13 * winheight(0) + 8) / 16)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
20
