...
setlocal path=~/rails_work/auth_six/lib,~/rails_work/auth_six/vendor,~/rails_work/auth_six/app/models/concerns,~/rails_work/auth_six/app/controllers/concerns,~/rails_work/auth_six/app/controllers,~/rails_work/auth_six/app/helpers,~/rails_work/auth_six/app/mailers,~/rails_work/auth_six/app/models,~/rails_work/auth_six/app/jobs,~/rails_work/auth_six/app/*,~/rails_work/auth_six/app/views,~/rails_work/auth_six/test,~/rails_work/auth_six/test/unit,~/rails_work/auth_six/test/functional,~/rails_work/auth_six/test/integration,~/rails_work/auth_six/test/controllers,~/rails_work/auth_six/test/helpers,~/rails_work/auth_six/test/mailers,~/rails_work/auth_six/test/models,~/rails_work/auth_six/test/jobs,~/rails_work/auth_six/vendor/plugins/*/lib,~/rails_work/auth_six/vendor/plugins/*/test,~/rails_work/auth_six/vendor/rails/*/lib,~/rails_work/auth_six/vendor/rails/*/test,~/rails_work/auth_six,~/**,.**,~/.rbenv/rbenv.d/exec/gem-rehash,~/.rbenv/versions/2.2.5/lib/ruby/site_ruby/2.2.0,~/.rbenv/versions/2.2.5/lib/ruby/site_ruby/2.2.0/x86_64
...
setlocal numberwidth=4
setlocal omnifunc=rubycomplete#Complete
setlocal path=~/rails_work/auth_six/lib,~/rails_work/auth_six/vendor,~/rails_work/auth_six/app/models/concerns,~/rails_work/auth_six/app/controllers/concerns,~/rails_work/auth_six/app/controllers,~/rails_work/auth_six/app/helpers,~/rails_work/auth_six/app/mailers,~/rails_work/auth_six/app/models,~/rails_work/auth_six/app/jobs,~/rails_work/auth_six/app/*,~/rails_work/auth_six/app/views,~/rails_work/auth_six/app/views/customers,~/rails_work/auth_six/app/views/application,~/rails_work/auth_six/public,~/rails_work/auth_six/test,~/rails_work/auth_six/test/unit,~/rails_work/auth_six/test/functional,~/rails_work/auth_six/test/integration,~/rails_work/auth_six/test/controllers,~/rails_work/auth_six/test/helpers,~/rails_work/auth_six/test/mailers,~/rails_work/auth_six/test/models,~/rails_work/auth_six/test/jobs,~/rails_work/auth_six/vendor/plugins/*/lib,~/rails_work/auth_six/vendor/plugins/*/test,~/rails_work/auth_six/vendor/rails/*/lib,~/rails_work/auth_six/vendor/rails/*/test,~/rails_work/auth_six,~/**,.**,~/.rbenv/rbenv.d/exec/
setlocal nopreserveindent
setlocal nopreviewwindow
setlocal quoteescape=\\
setlocal noreadonly
