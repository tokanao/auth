...
setlocal numberwidth=4
setlocal omnifunc=rubycomplete#Complete
setlocal path=~/rails_work/auth_pundit/lib,~/rails_work/auth_pundit/vendor,~/rails_work/auth_pundit/app/models/concerns,~/rails_work/auth_pundit/app/controllers/concerns,~/rails_work/auth_pundit/app/controllers,~/rails_work/auth_pundit/app/helpers,~/rails_work/auth_pundit/app/mailers,~/rails_work/auth_pundit/app/models,~/rails_work/auth_pundit/app/jobs,~/rails_work/auth_pundit/app/*,~/rails_work/auth_pundit/app/views,~/rails_work/auth_pundit/app/views/application,~/rails_work/auth_pundit/public,~/rails_work/auth_pundit/test,~/rails_work/auth_pundit/test/unit,~/rails_work/auth_pundit/test/functional,~/rails_work/auth_pundit/test/integration,~/rails_work/auth_pundit/test/controllers,~/rails_work/auth_pundit/test/helpers,~/rails_work/auth_pundit/test/mailers,~/rails_work/auth_pundit/test/models,~/rails_work/auth_pundit/test/jobs,~/rails_work/auth_pundit/vendor/plugins/*/lib,~/rails_work/auth_pundit/vendor/plugins/*/test,~/rails_work/auth_pundit/vendor/rails/*/lib,~/rails_work/auth_pundit/vendor/rails/*/test,~/rails_work/auth
setlocal nopreserveindent
setlocal nopreviewwindow
setlocal quoteescape=\\
setlocal noreadonly
